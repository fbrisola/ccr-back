...
class AddressesTableSeeder extends Seeder {
    ...
    public function run() {
        ...
        array('created_at' => date('Y-m-d h:m:s', time()), 'updated_at' => date('Y-m-d h:m:s', time()), 'street' => '', 'district' => '', 'city' => '', 'state' => '', 'zipcode' => '', 'phone' => ''),
...
class PeopleTableSeeder extends Seeder {
    ...
    public function run() {
        ...
        array('created_at' => date('Y-m-d h:m:s', time()), 'updated_at' => date('Y-m-d h:m:s', time()), 'name' => 'Fernando', 'lastname' => 'Brisola Batista', 'genre' => 'Masculino', 'birthdate' => '1969-12-03', 'email' => str_random(10) . '@gmail.com', 'married' => 'True', 'address_id' => '2'),
        array('created_at' => date('Y-m-d h:m:s', time()), 'updated_at' => date('Y-m-d h:m:s', time()), 'name' => 'Celia', 'lastname' => 'M Marques B Batista', 'genre' => 'Feminino', 'birthdate' => '1971-07-08', 'email' => str_random(10) . '@gmail.com', 'married' => 'True', 'address_id' => '2'),
        array('created_at' => date('Y-m-d h:m:s', time()), 'updated_at' => date('Y-m-d h:m:s', time()), 'name' => 'Raphael', 'lastname' => 'M Marques Brisola Batista', 'genre' => 'Masculino', 'birthdate' => '2005-04-07', 'email' => str_random(10) . '@gmail.com', 'married' => 'False', 'address_id' => '2'),
        array('created_at' => date('Y-m-d h:m:s', time()), 'updated_at' => date('Y-m-d h:m:s', time()), 'name' => 'Daniel', 'lastname' => 'M Marques Brisola Batista', 'genre' => 'Masculino', 'birthdate' => '2009-09-04', 'email' => str_random(10) . '@gmail.com', 'married' => 'False', 'address_id' => '2'),
        array('created_at' => date('Y-m-d h:m:s', time()), 'updated_at' => date('Y-m-d h:m:s', time()), 'name' => 'Fernanda', 'lastname' => 'M Marques Brisola Batista', 'genre' => 'Feminino', 'birthdate' => '2012-06-05', 'email' => str_random(10) . '@gmail.com', 'married' => 'False', 'address_id' => '2'),
        array('created_at' => date('Y-m-d h:m:s', time()), 'updated_at' => date('Y-m-d h:m:s', time()), 'name' => 'João', 'lastname' => 'da Silva', 'genre' => 'Masculino', 'birthdate' => date('Y-m-d', rand(0, time())), 'email' => str_random(10) . '@gmail.com', 'married' => 'False', 'address_id' => '1'),
        array('created_at' => date('Y-m-d h:m:s', time()), 'updated_at' => date('Y-m-d h:m:s', time()), 'name' => 'Maria', 'lastname' => 'da Silva', 'genre' => 'Feminino', 'birthdate' => date('Y-m-d', rand(0, time())), 'email' => str_random(10) . '@gmail.com', 'married' => 'False', 'address_id' => '1'),
